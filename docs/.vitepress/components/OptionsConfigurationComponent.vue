...
export default {
        ...
        options() {
            return Object.fromEntries(
                Object.entries(this.store.data).filter(
                    ...
                    ([_k, v]) =>
                        v.group.toLowerCase() === this.group.toLowerCase(),
                ),
            );
        },
    },
    methods: {
        ...
        useVerboseDefaults() {
            return getValue(
                this.store.data.GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS,
            );
        },
        getValue,
    },
        ...
        <table>
            ...
            <tbody>
                ...
                >
                    ...
                    <td v-if="hasNotes()" v-html="option?.notes" />
